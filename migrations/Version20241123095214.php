...
final class Version20241123095214 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE salles (id INT AUTO_INCREMENT NOT NULL, id_cinema_id INT NOT NULL, qualite_projection VARCHAR(255) NOT NULL, INDEX IDX_799D45AA34FE3891 (id_cinema_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE salles ADD CONSTRAINT FK_799D45AA34FE3891 FOREIGN KEY (id_cinema_id) REFERENCES cinemas (id)');
    }
